 ...
 <?php if(isset($_SESSION["email"])):?>
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary"
			...
			<br> <br>
			<h1 id="fh5co-logo">
				<a href="welcome.php"><img src="images/logo.png" width="135"
...
$sql = "SELECT p_id, title, desp, price, cat, dt, img1 FROM product where name='$name' order by p_id desc";
$result = $conn->query($sql);
				...
				<tr>
						...
						<div class=\"space\">
								...
								<a
									...
									href=\"myproduct.php?p_id=".$row["p_id"]."\" title=\"\">
						...
						<h3 class=\"large lheight20 margintop10\">
														<a href=\"myproduct.php?p_id=".$row["p_id"]."\" class=\"marginright5 link linkWithHash detailsLinkPromoted\">
								<span>".$row["title"] ."</span>
							</a>
